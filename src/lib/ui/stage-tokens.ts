...
export const STAGE_TOKENS: readonly StageToken[] = [
  ...
  },
  {
    ...
    group: "production",
    description: "Editorial passes: assess, revise, and approve every chapter",
  },
  {
    ...
    group: "production",
    description: "Final document: platform specs, front matter, ISBN, and export package",
  },
...
export const FICTION_STAGE_TOKENS: readonly StageToken[] = [
  ...
  { key: "EDITING", number: 9, label: "Editing", route: (slug) => `/books/${slug}/editing`, group: "production", description: "Editorial passes: assess, revise, and approve every chapter." },
